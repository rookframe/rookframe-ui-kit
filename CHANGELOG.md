...
## Unreleased - v1.0.0-rc.1 candidate
...
The pre-user `v1.0.0-rc.1` label may be updated by the owner. Consumers still
pin an exact commit. This implementation does not create, move, or publish a
release tag.
